<%-- 
    Document   : reflation
    Created on : 09-Oct-2018, 09:10:19
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Portal - Reflation Rights Account</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/accounts/reflation.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
